...
def convnext_base_v1_test():

    predictor = Predictor(model_name="convnext_base_v1", verbose=True)
...
def convnext_small_v1_test():

    predictor = Predictor(model_name="convnext_small_v1", verbose=True)
...
def convnext_tiny_v1_test():

    predictor = Predictor(model_name="convnext_tiny_v1", verbose=True)
